...
# hyperparameters
learning_rate = 0.1
# explore the first 5 episodes in decreasing epsilon, then use 0.01 for the rest 5 episodes
n_episodes = 100_000
start_epsilon = 1.0
# start_epsilon = 0.5
...
print(f"[train] {datetime.datetime.now().isoformat()} Training")  # noqa
...
for episode in tqdm(range(n_episodes)):
    ...
    plot_metrics(rewards_over_episodes, errors_over_episodes, f'e{episode}')  # noqa
